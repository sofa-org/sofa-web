...
import { ProgressRef } from '../InvestProgress';

import locale from './locale';

import styles from './index.module.scss';

addI18nResources(locale, 'AutomatorProgress');
...
export const AutomatorProgress = forwardRef<ProgressRef, ProgressProps>(
  (props, ref) => {
    const [t] = useTranslation('AutomatorProgress');
    ...
    }, [progress, props.vault, t, windowWidth, props.chainId]);
